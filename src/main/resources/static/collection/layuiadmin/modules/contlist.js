  ...
  table.on('tool(LAY-app-content-list)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        type: 2
        ,title: '编辑文章'
        ,content: '../../../views/page?url=/app/content/listform.html?id='+ data.id
        ,maxmin: true
        ,area: ['550px', '550px']
        ,btn: ['确定', '取消']
  ...
  table.on('tool(LAY-app-content-tags)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        type: 2
        ,title: '编辑分类'
        ,content: '../../../views/page?url=/app/content/tagsform.html?id='+ data.id
        ,area: ['450px', '200px']
        ,btn: ['确定', '取消']
        ,yes: function(index, layero){
          //获取iframe元素的值
  ...
  table.on('tool(LAY-app-content-comm)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        type: 2
        ,title: '编辑评论'
        ,content: '../../../views/page?url=/app/content/contform.html'
        ,area: ['450px', '300px']
        ,btn: ['确定', '取消']
        ,yes: function(index, layero){
          var iframeWindow = window['layui-layer-iframe'+ index]
